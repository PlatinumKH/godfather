...
class Game:
    def __init__(self, channel: discord.channel.TextChannel):
        ...
        self.setup = Setup  # the setup used
    ...
    def find_setup(self, bot, setup_name: str = None):
        num_players = len(self.players)

        if setup_name:
            setup = bot.setups.get(setup_name)
        ...
        if len(possible_setups) == 0:
            ...
            raise ValueError('No possible setup found.')

        return choice(bot, bot.get_user(self.host_id), self.channel,
